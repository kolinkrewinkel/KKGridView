...
- (void)addItems
{
    ...
    [_gridView insertItemsAtIndexPaths:[NSArray arrayWithObjects:[KKIndexPath indexPathForIndex:3 inSection:0], [KKIndexPath indexPathForIndex:1 inSection:0], nil] withAnimation:KKGridViewAnimationExplode];
}
